...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-c-morphing-command-bar-01": lazyRegistryComponent(
    () => import("@/registry/demo/components/spaceui/morphing-command-bar/c-morphing-command-bar-01/index.tsx"),
    {"corner":{"value":28,"min":10,"max":28,"step":2}},
  ),
};
