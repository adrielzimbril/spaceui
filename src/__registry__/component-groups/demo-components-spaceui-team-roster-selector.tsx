...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-c-team-roster-selector-01": lazyRegistryComponent(
    () => import("@/registry/demo/components/spaceui/team-roster-selector/c-team-roster-selector-01/index.tsx"),
    {"corner":{"value":24,"min":8,"max":36,"step":2},"maxDisplay":{"value":5,"min":2,"max":5,"step":1}},
  ),
};
