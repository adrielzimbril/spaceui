...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-c-frost-blurred-01": lazyRegistryComponent(
    ...
    {"text":{"value":"Space UI"},"layers":{"value":7,"min":3,"max":10,"step":1},"strength":{"value":1,"min":0.25,"max":2,"step":0.25},"height":{"value":"62%","options":{"Half":"50%","Default":"62%","Deep":"80%"}},"side":{"value":"bottom","options":{"Bottom":"bottom","Top":"top"}},"tint":{"value":0,"min":0,"max":0.6,"step":0.02}},
  ),
};
