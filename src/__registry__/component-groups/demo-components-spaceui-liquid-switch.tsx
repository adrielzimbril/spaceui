...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-c-liquid-switch-01": lazyRegistryComponent(
    () => import("@/registry/demo/components/spaceui/liquid-switch/c-liquid-switch-01/index.tsx"),
    {"stretch":{"value":36,"min":0,"max":100,"step":5},"disabled":{"value":false}},
  ),
};
