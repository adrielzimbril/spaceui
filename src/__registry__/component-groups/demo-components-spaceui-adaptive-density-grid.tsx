...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-c-adaptive-density-grid-01": lazyRegistryComponent(
    () => import("@/registry/demo/components/spaceui/adaptive-density-grid/c-adaptive-density-grid-01/index.tsx"),
    {},
  ),
  "demo-c-adaptive-density-grid-02": lazyRegistryComponent(
    () => import("@/registry/demo/components/spaceui/adaptive-density-grid/c-adaptive-density-grid-02/index.tsx"),
    {},
  ),
};
