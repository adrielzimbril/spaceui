...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-c-silk-border-01": lazyRegistryComponent(
    () => import("@/registry/demo/components/spaceui/silk-border/c-silk-border-01/index.tsx"),
    {},
  ),
  "demo-c-silk-border-02": lazyRegistryComponent(
    () => import("@/registry/demo/components/spaceui/silk-border/c-silk-border-02/index.tsx"),
    {},
  ),
  "demo-c-silk-border-03": lazyRegistryComponent(
