...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-c-chroma-palette-01": lazyRegistryComponent(
    () => import("@/registry/demo/components/spaceui/chroma-palette/c-chroma-palette-01/index.tsx"),
    {"count":{"value":5,"min":2,"max":5,"step":1},"corner":{"value":14,"min":4,"max":24,"step":2}},
  ),
};
