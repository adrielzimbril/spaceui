...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-c-liquid-metal-border-01": lazyRegistryComponent(
    () => import("@/registry/demo/components/spaceui/liquid-metal-border/c-liquid-metal-border-01/index.tsx"),
    {},
  ),
  "demo-c-liquid-metal-border-02": lazyRegistryComponent(
    () => import("@/registry/demo/components/spaceui/liquid-metal-border/c-liquid-metal-border-02/index.tsx"),
    {},
  ),
  "demo-c-liquid-metal-border-03": lazyRegistryComponent(
