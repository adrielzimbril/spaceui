...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-c-liquid-sortable-list-01": lazyRegistryComponent(
    () => import("@/registry/demo/components/spaceui/liquid-sortable-list/c-liquid-sortable-list-01/index.tsx"),
    {"corner":{"value":20,"min":8,"max":32,"step":2}},
  ),
};
