...
function stylesFor(source: EmojiSourceType): EmojiTypeType[] {
  return (validEmojiTypes[source] ?? [getEmojiDefaultType(source)]).filter(
    (item): item is EmojiTypeType => item !== EmojiType.Pure,
  )
}
