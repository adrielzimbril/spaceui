---
title: Date Selector
description: Allows users to quickly choose single dates or time ranges using interactive timeline scrubbers and preset shortcut buttons.
component: true
base: base
preview:
...
<ComponentInstallation name="components-spaceui-date-selector" />

## Usage

```tsx
import * as React from 'react'
import { DateSelector, type DateSelectorValue } from '@/components/spaceui/date-selector'

export default function SpaceUI() {
  const [value, setValue] = React.useState<DateSelectorValue | undefined>()
...
<ComponentPreview name="demo-c-date-selector-02" />

### With Dialog

<ComponentPreview name="demo-c-date-selector-03" />

### With i18n Support

<ComponentPreview name="demo-c-date-selector-04" />
