---
title: Pin List
description: Provides a quick-access bar where users can pin, organize, and reorder favorite items, documents, or shortcuts.
author:
  name: arhamkhnz
  url: https://github.com/arhamkhnz
preview: demo-c-pin-list-01
---

## Installation

<ComponentInstallation name="components-spaceui-pin-list" />
...
<TypeTable
  type={{
    items: {
      description: 'Array of items to show in the list. Each item should have id, name, info, icon, and pinned.',
      type: 'PinListItem[]',
      required: true,
    },
    labels: {
