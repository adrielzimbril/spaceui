...
## Live Interactive Loader

Live cycling loader with configurable animation speed, motion transitions, dot radius, matrix gap, ghost dots, and Tailwind color utilities:
...
<ComponentPreview name="demo-c-orb-loading-04" />
...
| `pattern` | `'diamond' \| 'corners' \| 'bands' \| 'scatter' \| 'diagonal' \| 'glyph' \| number` | `undefined` | Specific pattern for the embedded orb |
