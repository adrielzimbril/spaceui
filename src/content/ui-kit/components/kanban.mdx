---
title: Kanban
description: Displays tasks across draggable columns, allowing users to organize projects, track progress stages, and reorder cards intuitively.
component: true
base: base
preview:
...
<ComponentInstallation name="components-spaceui-kanban" />
...
import {
  ...
  KanbanItemHandle,
  KanbanOverlay,
} from '@/components/spaceui/kanban'
```
...
<ComponentPreview name="demo-c-kanban-02" className="**:[.preview]:h-auto" align="start" />

### Persist to a backend

<ComponentPreview name="demo-c-kanban-06" className="**:[.preview]:h-auto" align="start" />
...
<ComponentPreview name="demo-c-kanban-03" />

### Minimal kanban with stacked frame

<ComponentPreview name="demo-c-kanban-04" />

### Feature roadmap kanban with progress

<ComponentPreview name="demo-c-kanban-05" />
