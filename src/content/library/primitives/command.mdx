---
title: Command
description: Provides a searchable command menu that lets users navigate pages, find resources, and trigger shortcuts directly from their keyboard.

links:
  doc: https://base-ui.com/react/components/autocomplete#api-reference
preview: demo-p-command-01
---

## Installation

<ComponentInstallation name="primitives-command" />
...
| <Kbd>Enter</Kbd>     | Executes the highlighted action.              |
| <Kbd>Escape</Kbd>    | Closes the command palette.                   |
...
<ShowcaseGrid showLayoutToggle={false} columns={1}>
  <ShowcaseCard name="demo-p-command-02" description="Command palette with AI assistant" />
</ShowcaseGrid>
