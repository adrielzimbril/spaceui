---
title: Filters
description: Provides a filter bar with badges and active tags, allowing users to narrow down search results by multiple criteria simultaneously.
component: true
base: base
preview:
...
<ComponentInstallation name="components-spaceui-filters" />

## Usage

```tsx
import * as React from 'react'
import { createFilter, Filters, type Filter, type FilterFieldConfig } from '@/components/spaceui/filters'

export default function SpaceUI() {
  const [filters, setFilters] = React.useState<Filter[]>([createFilter('priority', 'is_any_of', ['low', 'medium'])])
...
<ComponentPreview name="demo-c-filters-02" align="start" />

### Trigger Button

<ComponentPreview name="demo-c-filters-03" align="start" />

### Small Size

<ComponentPreview name="demo-c-filters-04" align="start" />

### Large Size

<ComponentPreview name="demo-c-filters-05" align="start" />

### Custom Controls

<ComponentPreview name="demo-c-filters-06" align="start" />

### Data Grid

<ComponentPreview name="demo-c-filters-07" className="**:[.preview]:h-auto" align="start" />

### Nuqs

<ComponentPreview name="demo-c-filters-08" className="**:[.preview]:h-auto" align="start" />

### With i18n Support

<ComponentPreview name="demo-c-filters-09" align="start" />

### Virtualized Large Lists

<ComponentPreview name="demo-c-filters-10" align="start" />

### Prefetched Async Options

<ComponentPreview name="demo-c-filters-11" align="start" />

### Async Server-side Search

<ComponentPreview name="demo-c-filters-12" align="start" />
...
| `loadOptions`         | `(query: string) => FilterOption<T>[] \| Promise<FilterOption<T>[]>` | Async options loader for large or remote lists. Called with the current search query - return a prefetched list (ignore the query) or server-side search results. Debounced, with loading/error states and a value-to-label cache. `options` still seeds the initial view. |
| `renderOptionList`    | `(props: FilterOptionListRenderProps<T>) => ReactNode`               | Bring-your-own rendering for the options list, e.g. virtualization with a windowing library of your choice. Receives `{ options, highlightedIndex, renderOption }`; render the scrollable list and call `renderOption` for each row. Omit for the default plain list.      |
