...
description: Renders floating animated bubbles across the background that smoothly move and drift away when users move their mouse.
preview: demo-c-backgrounds-bubble-01
---
