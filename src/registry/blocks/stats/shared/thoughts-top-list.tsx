...
export function ThoughtsTopList({
  ...
  return (
    <Frame
      ...
      className={cn('size-full bg-muted squircle/100 rounded-6xl border-0 overflow-hidden p-4 md:p-6', className)}
    >
      <Card className="relative flex flex-col size-full items-center justify-start gap-4 md:gap-8 p-4 squircle/100 rounded-2xl md:rounded-4xl bg-background border-0 overflow-hidden">
        <motion.div
          animate={{
