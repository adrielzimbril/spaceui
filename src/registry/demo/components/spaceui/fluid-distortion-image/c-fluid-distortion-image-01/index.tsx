...
import { FluidDistortionImage } from '@/registry/components/spaceui/fluid-distortion-image'
import { Button } from '@/registry/primitives/button'
import { tickSound } from '@/components/providers/sound-provider'
import { cn } from '@/registry/lib/utils'

export interface FluidDistortionImageDemoProps {
  textureFile?: string
      ...
      <AnimatePresence mode="wait" initial={false}>
        ...
        >
          <FluidDistortionImage
            key={`${effectiveSrc}-${distortionIntensity}-${relaxationSpeed}-${radius}-${revealStyle}`}
            src={effectiveSrc}
            alt="Scenic fluid interactive artwork"
            distortionIntensity={Number(distortionIntensity)}
            relaxationSpeed={Number(relaxationSpeed)}
