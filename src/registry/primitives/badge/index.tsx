...
export function Badge({ className, variant, size, square, render, ...props }: BadgeProps): React.ReactElement {
  const defaultProps = {
    className: cn(square && 'aspect-square', badgeVariants({ className, size, variant })),
    'data-slot': 'badge',
  }
